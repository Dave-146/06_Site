            ...
            <form onSubmit={handleSubmit} className="space-y-6 flex-1 flex flex-col">
              ...
              <div className="flex-1 flex flex-col">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-primary focus:border-primary flex-1"
                  required
                ></textarea>
              </div>
              ...
              <button 
                type="submit" 
                className="btn-primary w-full disabled:opacity-50 disabled:cursor-not-allowed mt-auto"
